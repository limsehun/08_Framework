...
@Slf4j // log필드 생성 및 초기화 자동완성 lombok 어노테이션
...
public class ExampleController {
	...
	// 1) page : 현재 Servlet 혹은 JSP 페이지
	
	// 2) request : 요청 받은 곳 + 요청 위임 (forward) 받은곳
	
	// 3) session : 클라이언트가 서버 최초 연결 시 생성, 연결한 브라우저 종료 또는 세션 시간 만료까지 
	
	// 4) application : 서버 실행시 1개만 생성, 서버 종료시까지 유지
	 ...
	 */
	 ...
	 public String ex2(Model model) {
		 ...
		 model.addAttribute("str", "<h1>테스트 중입니다... &times; </h1>"); /*time 는 곱하기 (횟수를 의미?)*/
	 ...
	 */
	 ...
	 @GetMapping("ex3/{number}")/*{}안은 {}의 이름 설정 아무거나 되는 듯*/
	...
	public String ex4(Model model) {
		 ...
		 Student std = new Student("3333","짱구", 5, null);
