 ...
 * 	사이에 요청/응답을 가로채서 수행
 * 
 * 3) afterCompletion() - forward 된 뷰가 완성된 후
 * 	View Resolver -> Dispathcher Servlet 사이 수행
 * 
 */
...
//		log.info("------ BoardTypeInterceptor 전처리 메서드 실행 ------");
		...
		// 어떤 요청이 와도
		// header에 출력되는 게시판 메뉴를 DB에서 얻어와 Application Scope에 세팅
