...
@RestController // @Controller + @ResponsBody = 비동기 요청 전용 컨트롤러, return되는 모든 값이 있는 그대로 호출부로 반환
...
public class CommentController {
	 ...
	 * 댓글 등록
	 * 
	 * @param comment     : 요청 시 body에 JSON 형태로 담겨져 제출된 데이터를 HttpMessageConverter가
	 *                    DTO로 변환한 객체 (boardNo, commentContent)
	 * 
